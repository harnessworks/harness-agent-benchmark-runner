...
- After you identify the relevant implementation direction, do not stop after narrating a plan; make the first small scoped app/test/docs edit immediately, then continue.
