...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "run":
        ...
        if args.json:
            ...
            print(f"record_consistent_success: {scoring.get('record_consistent_success')}")
            print(f"mistake_prevention_success: {scoring.get('mistake_prevention_success')}")
            print(f"repeated_documented_mistake: {scoring.get('repeated_documented_mistake')}")
